...
class Product(models.Model):
    ...
    stat = models.CharField(max_length=50,
                            choices=stat_choices, default='COURAGE')
    price = models.IntegerField()
    color = models.CharField(max_length=20,
                             choices=color_choices, default='PURPLE')
...
class StaffSubmission(models.Model):
    ...
    variable_one_option_one = models.CharField(max_length=254,
                                               null=True, blank=True)
    variable_one_option_two = models.CharField(max_length=254,
                                               null=True, blank=True)
    variable_one_option_three = models.CharField(max_length=254,
                                                 null=True, blank=True)
    variable_two = models.CharField(max_length=50, null=True, blank=True)
    variable_two_option_one = models.CharField(max_length=254,
                                               null=True, blank=True)
    variable_two_option_two = models.CharField(max_length=254,
                                               null=True, blank=True)
    variable_two_option_three = models.CharField(max_length=254,
                                                 null=True, blank=True)
    variable_three = models.CharField(max_length=50, null=True, blank=True)
    variable_three_option_one = models.CharField(max_length=254,
                                                 null=True, blank=True)
    variable_three_option_two = models.CharField(max_length=254,
                                                 null=True, blank=True)
    variable_three_option_three = models.CharField(max_length=254,
                                                   null=True, blank=True)
