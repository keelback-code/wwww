...
"""
Models to create object for checkout,
based on Code Institute's Boutique Ado wakthrough.
"""
...
class Order(models.Model):
    ...
    grand_total = models.DecimalField(max_digits=10, decimal_places=2,
                                      null=False, default=0)
    original_loot = models.TextField(null=False, blank=False, default='')
...
class OrderLineItem(models.Model):
    ...
    def __str__(self):
        return f'{self.product.product_type} on order \
